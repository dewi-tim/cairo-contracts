...
func isApprovedForAll{
    ...
    let (approved) = ERC1155_operator_approvals.read(
                        account = account,
                        operator = operator
                    )
    return (approved)
...
func balanceOfBatch{
        ...
        batch_balances_low_len : felt,
        batch_balances_low : felt*,
        batch_balances_high_len : felt,
...
func balance_of_batch_iter{
    ...
    uint256_check(id)
    let (balance : Uint256) = ERC1155_balances.read(
        id_low=id.low,
        id_high=id.high,
        account=account
    )
